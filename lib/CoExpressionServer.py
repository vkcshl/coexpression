...
from CoExpressionImpl import CoExpression
impl_CoExpression = CoExpression(config)
                    ...
                    if auth_req != "none":
                        if token is None and auth_req == 'required':
                            ...
                            err.data = "Authentication required for " + \
                                "CoExpression but no authentication header was passed"
                            raise err
